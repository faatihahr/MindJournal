            ...
            {loading ? (
              ...
              <div className="space-y-4">
                ...
                <div className={`mb-6 p-4 rounded-lg border-2 transition-all duration-200 ${
                  ...
                  <div className={`flex items-start space-x-3 ${isDarkMode ? 'text-yellow-200' : 'text-yellow-800'}`}>
                    <div className="text-lg">⚠️</div>
                    <div>
                      <h4 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-yellow-100' : 'text-yellow-900'}`}>
                        Disclaimer
                      </h4>
                      <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-yellow-200' : 'text-yellow-700'}`}>
                        These insights are generated by AI analysis and are not based on professional expertise or medical advice. They are intended for personal reflection only and should not replace professional consultation.
                      </p>
                    </div>
                  </div>
                </div>
